        ...
        <div style={{ padding: '32px', display: 'flex', gap: '32px', alignItems: 'stretch', borderRadius: '20px', overflow: 'hidden' }}>
          ...
          <div style={{ 
            ...
            <div style={{ marginBottom: '32px', marginTop: '-24px' }}>
              ...
              >
                AI-powered aviation safety system that learns from past crashes to prevent future disasters
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0', flex: '1', marginTop: '-24px' }}>
              {[
                { 
                  key: 'story' as const, 
                  label: 'Story', 
                  content: 'What if we could prevent aviation disasters before they happen? The Air India crash inspired AirPilot—an AI system that learns from thousands of historical accidents to identify patterns and predict risks. We built something that could save lives.' 
                },
                { 
                  key: 'technical' as const, 
                  label: 'Technical Challenges', 
                  content: [
                    '• Comprehensive aviation crash database from multiple sources',
                    '• Vector embeddings for semantic pattern recognition',
                    '• Natural language processing for unstructured crash reports',
                    '• Weather data integration and analysis',
                    '• Flight parameter correlation algorithms',
                    '• Machine learning models for risk prediction',
                    '• Real-time risk assessment and alerting system',
                ...
                { 
                  ...
                  label: 'Impact', 
                  content: [
                    '• Potential to prevent catastrophic aviation accidents',
                    '• Real-time risk identification for pilots and ATC',
                    '• Learning from thousands of historical incidents',
                    '• Predictive insights for flight safety',
                    '• Early warning system for dangerous conditions',
                    '• Could save countless lives through prevention',
